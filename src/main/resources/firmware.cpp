...
#define DOOR_CONTRACT  "[LOCK_CONTRACT]" // Contract address of an NFT you hold on the network you are using (default Sepolia)
#define DEVICE_PRIVATE_KEY "[DEVICE_KEY]" // any private key - use MetaMask to create a new account; this will be the
